...
/**
 * 툴팁·드래프트 카드에서 넘치지 않는 상한 (좁은 쪽 기준 대략 20자/줄).
 *
 * 2026-09-05에 60 → 75. 요약 26종을 사용자가 준 문장 그대로 싣기로 하면서
 * 네 종(절벽 위에 피어난 꽃·이중 선언·정적의 손·미래를 보는 자)이 60자를 넘었다.
 * 문장을 줄이는 대신 상한을 올린다 — 뜻이 바뀌지 않는 쪽이 우선이다.
 */
const BRIEF_MAX = 75;
