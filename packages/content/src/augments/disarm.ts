...
export const disarm: AugmentDef = defineAugment({
   ...
   */
  detail:
    "지목당한 증강은 이번 국 내내 규칙도 발동 효과도 버튼도 서지 않는다. 다만 그 증강이 **이미 만들어 둔 것**(만들어 낸 패·바뀐 손패)은 대체로 그대로 남는다 — 일부 증강만 잠기는 순간 원래대로 돌아간다.\n\n한 국에 한 명의 증강 하나만 잠글 수 있고, 지목은 전원에게 공개되며 국이 끝나면 증강도 돌아온다.",
  install(ctx) {
