...
export const mirrorDora: AugmentDef = defineAugment({
  ...
  name: "거울",
  description:
    "(상시) 도라 표시패의 앞 패도 나에게만 도라가 된다. 예를 들어 표시패가 5통이면 6통과 함께 4통도 내 도라다. 깡도라 표시패에도 똑같이 적용된다.",
  detail:
    "도라 표시패의 앞 패도 나에게만 도라가 된다. 표시패가 5통이면 6통과 4통이 둘 다 도라다. 1의 앞은 9, 동의 앞은 북, 백의 앞은 중이다.\n\n깡도라에도 적용되지만 뒷도라에는 적용되지 않는다.",
  install(ctx) {
    const { holder } = ctx;
