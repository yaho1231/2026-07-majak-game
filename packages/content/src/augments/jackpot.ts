...
export const jackpot: AugmentDef = defineAugment({
  ...
  detail:
    "(매 국 1회 · 국의 첫 순) 아직 아무것도 버리지 않은 첫 순에만 룰렛을 돌릴 수 있다. 그 자리에서 0.5배(30%)·1배(30%)·2배(30%)·3배(10%) 중 하나가 뽑혀 전원에게 공개된다.\n\n그 국의 정산에서 자신의 획득 점수가 양수이면 뽑힌 배수만큼 곱해진다(0.5배는 절반으로 줄고, 결과는 100점 단위로 맞춰진다). 늘어난 몫은 뱅크가 지급한다.\n\n**회수하는 리치봉(공탁)은 배수에서 빠진다** — 남이 낸 봉을 3배로 불리면 그만큼을 뱅크가 새로 찍어내는 셈이라 공탁 총량이 맞지 않기 때문이다. 본장 보너스는 획득분에 포함되어 함께 곱해진다.\n\n0.5배로 줄어든 몫은 그만큼 지불자에게 되돌아가므로 상대는 어느 경우에도 원래보다 더 내지 않는다. 지불로 끝난 국에는 적용되지 않으며, 굴리지 않은 국에는 아무 효과가 없다.",
