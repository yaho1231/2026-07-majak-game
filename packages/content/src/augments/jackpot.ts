...
export const jackpot: AugmentDef = defineAugment({
  ...
  name: "일확천금",
  description:
    "(매 국 1회 · 국의 첫 순) 배패를 받은 직후 룰렛을 돌려 0.5배, 1배, 2배, 3배 중 하나를 뽑는다. 그 국에 얻는 점수에 뽑힌 배수가 곱해진다. 본장과 공탁 회수분은 제외한다.",
  detail:
    "국의 첫 순에 룰렛을 돌려 0.5배, 1배, 2배, 3배 중 하나를 뽑고, 그 배수가 그 국의 화료점에 곱해진다. 결과는 모두에게 공개된다.\n\n본장과 공탁 회수분에는 곱해지지 않는다. 다른 배수 증강과 겹쳐도 기준은 손의 화료점이다. 늘어난 점수는 뱅크가 내고, 줄어든 점수는 지불자에게 돌아간다.",
