...
export const bigHand: AugmentDef = defineAugment({
  ...
  name: "큰손",
  description:
    "(2국에 1회) 국의 첫 순에 선언하면, 그 국에 화료했을 때 내가 받는 총액이 최소 만관(오야 12,000 · 자 8,000)이 된다.",
  detail:
    "국의 첫 순(버리기도 울기도 전)에 선언하면, 그 국에 화료했을 때 내가 받는 총액이 최소 만관(오야 12,000 · 자 8,000)이 된다.\n\n국의 첫 순(패를 버리거나 울기 전)에 선언하면, 그 국에 화료했을 때 내가 받는 총액이 최소 만관(오야 12,000 · 자 8,000)이 된다.\n\n하한은 본장·공탁 회수분과 배수 증강까지 모두 더한 총액에 적용된다. 화료하지 못해도 쿨다운은 소모된다.",
  install(ctx) {
