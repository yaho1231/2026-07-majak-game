...
export const devilsAdvance: AugmentDef = defineAugment({
  ...
  description:
    "(게임 내 1회 · 게임 시작 드래프트 전용) 첫 국에 뱅크에서 10,000점을 먼저 받고, 이후 만관 이상으로 화료하면 상대 셋에게서 각 3,000점을 걷어 빚을 갚는다.",
  detail:
    "(게임 내 1회 · 게임 시작 드래프트 전용) 빚은 '가불 10,000'으로 전원에게 공개되고 터진 뒤 '청산'으로 바뀐다. 걷은 9,000점은 빚을 갚는 돈이라 화료점에 더해지지 않는다 — 화료점은 표준 그대로이고 상대 셋만 줄어든다. 끝내 만관을 못 쳐도 상환은 없다.",
  install(ctx) {
    const { holder } = ctx;
