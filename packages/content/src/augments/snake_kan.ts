...
export const snakeKan: AugmentDef = defineAugment({
  ...
  detail:
    "(상시) 슌쯔로도 커쯔(깡)로도 세어 또이또이·산안커에도, 일기통관·삼색동순에도 들어가며 비싼 쪽이 잡힌다. 산깡쯔·스깡쯔에도 포함되지만 삼색동각처럼 같은 숫자를 요구하는 역에는 들어가지 않는다. 리치 중에는 선언할 수 없다.\n\n끝없는 윤회를 함께 들면 **9와 1을 넘는 연속**도 장사진이 된다.",
  install(ctx) {
