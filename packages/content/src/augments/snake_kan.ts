...
export const snakeKan: AugmentDef = defineAugment({
  ...
  detail:
    "(상시) 같은 무늬 연속 4장(3-4-5-6 등)을 손에 모으면 장사진으로 선언해 눕힐 수 있고, 영상패 보충 쯔모와 새로운 도라 개봉이 표준 깡과 똑같이 따라온다. 채점에서는 슌쯔로도 커쯔(깡)로도 셀 수 있어 또이또이·산안커·스안커에 넣을 수도, 일기통관·삼색동순에 넣을 수도 있으며 둘 중 비싼 쪽이 자동으로 잡힌다. 깡 자체로도 세어 산깡쯔·스깡쯔에 포함된다. 다만 삼색동각처럼 같은 숫자를 요구하는 역에는 들어가지 않는다. 리치 중에는 선언할 수 없다.\n\n끝없는 윤회를 함께 들고 있으면 **9와 1을 넘는 연속**도 장사진이 된다 — 8-9-1-2, 9-1-2-3도 하나의 깡이다.",
  install(ctx) {
