...
export const letItRide: AugmentDef = defineAugment({
  ...
  detail:
    "연속으로 화료할수록 화료 점수에 붙는 배수가 오른다 — 1배·2배·3배로 오르고 4연속부터는 4배에서 멈춘다. 본장 보너스와 회수하는 리치봉(공탁)은 배수 없이 원래 액수 그대로 들어온다.\n\n내가 방총당하거나, 유국이거나, **상대가 론으로 화료하면** 연승이 초기화되지만 잃는 점수는 없다. 상대의 쯔모는 연승을 끊지 않는다. 지금 몇 배인지는 전원에게 공개된다.",
  install(ctx) {
    const { holder } = ctx;
