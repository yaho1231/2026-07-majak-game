 ...
 *   3연속 **3배**, 4연속 이상 **4배**(상한).
 * - 내가 방총당하거나, 유국이거나, **상대가 론으로 화료하면** 연승이 초기화되어 다음
...
export const letItRide: AugmentDef = defineAugment({
   ...
   */
  conflicts: ["jackpot", "blood_contract"],
  complexity: 2,
  name: "판돈 굴리기",
  description:
    "(상시) 연속으로 화료할수록 손의 점수에 붙는 배수가 1배, 2배, 3배로 오르고, 4연속 이상은 4배가 된다. 본장과 공탁은 대상이 아니다.",
  detail:
    "연속으로 화료할수록 손의 화료점 배수가 1배, 2배, 3배로 오르고 4연속부터 4배가 된다.\n\n본장과 리치봉 회수분은 배수 대상이 아니다. 내가 방총당하거나, 유국이 되거나, 상대가 론으로 화료하면 연승이 끊긴다. 상대의 쯔모로는 끊기지 않는다. 현재 배수는 모두에게 공개된다.",
  install(ctx) {
    const { holder } = ctx;
