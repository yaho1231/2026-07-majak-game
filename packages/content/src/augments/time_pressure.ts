...
export const timePressure: AugmentDef = defineAugment({
   ...
   */
  detail:
    "타패, 론·치·퐁·깡 선언, 액티브 증강 선택이 모두 5초 제한 대상이다. 시간을 넘기면 쯔모기리·패스로 자동 진행되고, 여러 단계짜리 발동은 남은 후보 중 하나로 끝맺는다.\n\n⚠ 5초 제한은 **사람에게만** 걸린다 — 봇은 받지 않는다.\n\n반장전에서는 게임 내 1회, 자기 순에 다시 장전할 수 있다 — 누르면 그 자리에서 곧바로 그 국에 켜진다. (동풍전에는 없다.)",
  install(ctx) {
