...
export const timePressure: AugmentDef = defineAugment({
  ...
  name: "초읽기",
  description:
    "(획득 즉시 · 이번 국만) 나를 포함한 모든 참가자의 결정에 5초 제한이 걸린다. 시간을 넘기면 쯔모기리나 패스로 자동 진행된다. 반장전에서는 게임 중 1회 다시 발동할 수 있다.",
  /*
