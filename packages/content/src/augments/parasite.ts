...
export const parasite: AugmentDef = defineAugment({
  ...
  detail:
    "(매 국 1회) 지정은 전원에게 공개되고 국이 끝나면 풀린다. 옮겨 오는 몫은 100점 단위이며, 숙주가 잃는 국에는 아무 영향이 없어 테이블 총점은 변하지 않는다.\n\n⚠ **숙주가 누구에게서 벌었는지는 따지지 않는다** — 내가 숙주에게 방총해도 그 화료는 '숙주가 얻는 점수'라 절반이 되돌아온다.",
  install(ctx) {
