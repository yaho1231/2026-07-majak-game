...
export const mixedNineGates: AugmentDef = defineAugment({
  ...
  name: "뒤섞인 아홉 개의 연꽃",
  description:
    "(상시 · 멘젠 한정) 구련보등이 무늬를 가리지 않는다 — 만·통·삭을 하나로 보고 1,112,345,678,999 + 아무 수패 1장이면 역만이다.",
  detail:
    "무늬를 섞어 1112345678999 + 아무 수패 1장을 모으면 성립한다. 화료형 14장에 **자패가 한 장도 섞이면 안 된다**. 무늬가 한 종류뿐이면 표준 구련보등이 적용된다.\n\n뼈대가 선 동안에는 치·퐁·깡(안깡 포함) 버튼이 뜨지 않는다.",
  install(ctx) {
