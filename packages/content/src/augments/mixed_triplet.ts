...
export const mixedTriplet: AugmentDef = defineAugment({
  ...
  name: "동수의 결속",
  description:
    "(동풍전 2국에 1회, 반장전 3국에 1회) 국의 첫 순에 발동하면 이번 국 동안 커쯔의 무늬 제한이 사라진다. 1만·1통·1삭도 하나의 커쯔로 인정한다. 슌쯔와 머리는 여전히 같은 무늬여야 한다.",
  detail:
    "국의 첫 순에 발동하면 이번 국 동안 커쯔의 무늬 제한이 사라진다. 1만·1통·1삭도 한 커쯔로 인정하고, 퐁·깡도 할 수 있다.\n\n한 장이라도 버린 뒤에는 발동할 수 없다. 슌쯔와 머리는 여전히 같은 무늬여야 하므로 1만+1통 머리는 인정하지 않는다. 무늬가 섞인 커쯔로는 청일색·혼일색·삼색동각이 성립하지 않는다. 양극을 함께 가지고 있으면 1과 9의 구별도 사라진다.",
