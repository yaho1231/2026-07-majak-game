...
export const conjureDraw: AugmentDef = defineAugment({
  ...
  detail:
    "(매 국 1회) 자기 순에 손패 1장을 지목해 그 패의 종류를 목표로 삼는다. 다음 내 쯔모는 패산이 아니라 허공에서 생성되어 그 패의 복제(생성패)로 손에 들어오며, 손패 장수는 정상 그대로다. 깡으로 뽑는 영상패에는 반응하지 않는다. 무엇을 불렀는지는 발동 즉시 전원에게 공개된다.",
  install(ctx) {
