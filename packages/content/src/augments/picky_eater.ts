...
export const pickyEater: AugmentDef = defineAugment({
  ...
  name: "편식",
  description:
    "(2국에 1회) 한 무늬의 수패(자패는 허용)만 12장 버리면 열리고, 발동하면 손패의 수패를 원하는 한 색으로 통일한다.",
  detail:
    "(2국에 1회) 만·통·삭 중 다른 무늬의 수패를 한 장이라도 버리면 그 국의 진행은 실패하고, 진행도는 국이 바뀌면 처음부터 다시 센다. 리치 중에는 발동할 수 없다. 숫자는 유지돼 청일색이 성립하지만 ⚠ **손패의 적도라는 물들면 빨간색을 잃는다.**",
  install(ctx) {
