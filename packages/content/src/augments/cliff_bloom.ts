...
export const cliffBloom: AugmentDef = defineAugment({
  ...
  name: "절벽 위에 피어난 꽃",
  description:
    "(상시 · 만개는 동풍전 1회 · 반장전 2회) 뽑아올 영상패를 직접 고른다. 한 국에 깡을 두 번 하면 그 자리에서 반드시 화료할 수 있다.",
  detail:
    "영상패는 국에 4장뿐이고 깡마다 소모되어 보충되지 않으므로, 깡이 늘수록 고를 수 있는 폭이 좁아진다.\n\n만개는 지금 손패에서 살릴 수 있는 패를 최대한 살린 화료형으로 재구성된다. 만개한 국이 아니면 화료에 아무것도 얹히지 않으며, 역만에는 미적용이다.\n\n만개 횟수를 다 쓴 뒤에도 영상패를 고르는 것은 그대로 계속된다.",
  install(ctx) {
