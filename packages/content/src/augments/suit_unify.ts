...
export const suitUnify: AugmentDef = defineAugment({
  ...
  name: "단색 세계",
  description:
    "(동풍전 1회 · 반장전 2회 · 매 국 1회) 자기 순에 만·통·삭 중 색을 골라 손패의 수패를 전부 그 색으로 바꾼다. 숫자는 그대로다.",
  detail:
    "(동풍전 1회 · 반장전 2회 · 매 국 1회) 통일된 색으로 청일색이 인정되고, 어느 색인지는 전원에게 공개된다. 새 패는 패산의 같은 숫자와 맞바꿔 오고 내 패는 패산 맨 밑으로 간다. 리치 중에는 발동할 수 없다.\n\n⚠ **적도라(빨간 5)를 물들이면 그 빨간색은 사라진다.**",
  install(ctx) {
