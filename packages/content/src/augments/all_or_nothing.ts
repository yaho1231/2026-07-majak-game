...
export const allOrNothing: AugmentDef = defineAugment({
  ...
  name: "모 아니면 도",
  description:
    "(매 국 1회 · 리치는 국당 한 번) 리치를 선언할 때 '올인'을 함께 걸어 현재 점수의 절반을 판돈으로 건다. 올인 여부는 모두에게 공개된다.",
  detail:
    "리치를 걸 때 '올인'을 함께 걸면 현재 점수의 절반(1,000점 단위 내림)이 판돈이 된다.\n\n그 리치로 화료하면 판돈만큼 뱅크에서 더 받고, 상대가 화료하면 판돈의 절반을 뱅크에 잃는다. 유국이면 잃지 않고, 리치가 풀리면 판돈도 사라진다.\n\n리치는 국당 한 번이므로 리치 증강을 여러 개 가지고 있어도 그 국에는 하나만 사용할 수 있다.",
  install(ctx) {
