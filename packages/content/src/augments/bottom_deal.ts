...
export const bottomDeal: AugmentDef = defineAugment({
  ...
  name: "밑장빼기",
  description:
    "(2순에 1회) 패산 맨 밑 3장을 항상 볼 수 있고, 사용하면 다음 쯔모를 패산 위가 아니라 밑에서 뽑는다.",
  detail:
    // 첫 문단이던 «패산 맨 밑 3장이 항상 나에게 보이고, 사용하면…»은 뺐다 — 설명 카드는 요약(briefOf)
    // 바로 밑에 상세를 펴는데, 요약이 같은 말을 이미 해서 한 카드에 두 번 읽혔다(2026-09-25, docs/59 U35).
