...
export const fullHandSwap: AugmentDef = defineAugment({
  ...
  name: "통째로 바꾸기",
  description:
    "(동풍전 2회 · 반장전 3회) 내 첫 순에 상대를 지정해 그 손패를 통째로 가져온다. 고를 때 내 손패보다 완성이 빠른 상대에게 표식이 붙는다. 내 손패는 패산 맨 밑으로 들어가고, 상대는 패산에서 새로 받는다. 리치를 선언한 상대에게는 사용할 수 없다.",
  detail:
    "내 첫 순(한 장도 버리기 전)에 상대 한 명의 손패를 통째로 빼앗는다. 내 손패는 패산 맨 밑으로 가고, 상대는 패산에서 새로 받는다.\n\n내 첫 순(한 장도 버리기 전)에 상대 한 명의 손패를 통째로 가져온다. 내 손패는 패산 맨 밑으로 가고, 상대는 패산에서 새로 받는다.\n\n고를 때 내 손패보다 샹텐이 빠른 상대에게 '빠름' 표식이 나에게만 붙는다. 얼마나 빠른지는 알 수 없다.\n\n리치한 상대는 고를 수 없지만 숨은 리치는 고를 수 있고 그 리치는 풀린다. 손패 장수가 다른 상대에게는 사용할 수 없고, 직전에 울어 쯔모패가 없는 순에도 사용할 수 없다.",
  install(ctx) {
