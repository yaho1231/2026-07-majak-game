...
export const blindRon: AugmentDef = defineAugment({
  ...
  name: "눈먼 총알",
  description:
    "(획득 즉시 · 이번 국만 · 반장전은 게임 내 1회 재장전) 이 국에서 나오는 모든 론은 네 명 중 무작위로 뽑힌 한 명이 대신 낸다. 화료자 자신이 뽑히면 자기 몫은 자기가 낸다.",
  detail:
    "이 국의 모든 론은 네 명 중 무작위 한 명이 지불한다. 화료한 사람 자신이 뽑히면 자기 화료점을 자기가 낸다.\n\n쯔모에는 적용되지 않고, 공탁·본장은 원래대로 정산된다.\n\n반장전에서는 게임 내 1회, 자기 순에 다시 장전해 그 국에 바로 발동할 수 있다. 동풍전에서는 재장전이 없다.",
  install(ctx) {
    const { holder } = ctx;
