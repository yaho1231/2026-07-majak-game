...
export const hiddenRiver: AugmentDef = defineAugment({
  ...
  name: "안개 덮인 바닥",
  description:
    "(동풍전 1회 · 반장전 2회) 자기 순에 선언하면 그 국이 끝날 때까지 네 사람 모두의 바닥에서 최근 6장만 공개되고, 그 앞의 버림패는 장수만 보인다. 나만 네 사람의 바닥을 전부 볼 수 있다.",
  detail:
    "선언하면 그 국이 끝날 때까지 네 사람 바닥에서 최근 6장만 공개되고 그 앞은 장수만 보인다. 나만 전부 볼 수 있다.\n\n최근 6장은 모두에게 보이므로 직전 한 바퀴의 현물로는 여전히 수비할 수 있다.",
