...
export const scapegoat: AugmentDef = defineAugment({
  ...
  detail:
    "(매 국 1회) **지목당한 사람이 전액을 혼자 내고 나머지 두 명은 한 푼도 내지 않는다** — 그 국 정산에서 다른 증강이 새로 부과하는 지불까지 그 사람에게 몰린다.\n\n론으로 화료할 때는 아무것도 바뀌지 않는다. 지목은 한 번 정하면 그 국에는 못 바꾼다. 전액을 문 사람은 점수가 모자라면 마이너스로 떨어져 탈락할 수 있다.",
  install(ctx) {
