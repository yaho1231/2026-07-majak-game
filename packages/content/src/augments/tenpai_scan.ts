...
export const tenpaiScan: AugmentDef = defineAugment({
  ...
  name: "천리안",
  description:
    "(매 국 1회) 자기 순에 선언하면 그 순간 텐파이인 상대가 누구인지 당신에게만 밝혀진다. 손패 내용이나 대기패는 알 수 없다.",
  detail:
    "(매 국 1회) 자기 순에 선언하면 그 순간 세 상대 중 텐파이인 사람이 누구인지가 오직 당신 화면에만 표시된다. 리치를 걸지 않은 다마텐도 잡아내지만 손패 내용이나 대기패까지는 알 수 없다. 결과는 선언한 순간의 스냅샷이며, 발동 사실도 밝혀진 목록도 상대에게는 공개되지 않는다. 사용 횟수는 매 국 시작 시 초기화된다.",
