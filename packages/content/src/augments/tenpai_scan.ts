 ...
 *   국당 1회여도 판을 뒤집지 않는다. 2026-09-14 사용자 지시(#511)로 다시 국당 2회로
 *   올렸다 — #512 머지 사고로 되돌려졌던 것을 2026-09-16 에 다시 적용했다(docs/55 §2-1 M-1).
...
/** 국당 사용 횟수 — 2026-09-14 사용자 지시로 1회 → 2회 (#511, 2026-09-16 재적용) */
...
export const tenpaiScan: AugmentDef = defineAugment({
  ...
  name: "천리안",
  description:
    "(매 국 2회) 자기 순에 선언하면 그 순간 텐파이인 상대가 누구인지와 대기가 얼마나 넓은지, 노텐인 상대는 텐파이까지 몇 장 남았는지를 나만 볼 수 있다.",
  detail:
