...
export const avenger: AugmentDef = defineAugment({
  ...
  name: "복수자",
  description:
    "(상시) 나를 쏜 상대에게는 후리텐이어도, 역이 없어도(머리 1개와 몸통 4개 형태는 필요) 론할 수 있다. 그 론에는 2판이 붙는다.",
  detail:
    "나를 쏜 상대가 원수가 된다. 원수에게는 후리텐이어도, 역이 없어도 론할 수 있다. 다만 머리 1개와 몸통 4개의 형태는 갖춰야 한다. 그 론에는 2판이 붙는다(역만 제외).\n\n원수를 론으로 잡으면 원한이 풀린다. 다른 사람에게 방총당하면 원수가 그 사람으로 바뀐다. 쯔모나 다른 사람의 론에는 효과가 없다.\n\n원수를 론으로 잡으면 원한이 풀린다. 다른 사람에게 방총당하면 원수가 그쪽으로 바뀐다. 쯔모나 다른 사람 론에는 아무 효과도 없다.",
