...
export const giantGod: AugmentDef = defineAugment({
  ...
  name: "마작의 거신병",
  description:
    "(매 국 1회) 국사무쌍 13종을 내가 직접 전부 버렸을 때만 발동할 수 있다. 발동하면 그 13장이 손패로 돌아와 13면 대기가 되고, 다음 순에 화료한다.",
  detail:
    "이번 국에 국사무쌍 13종을 전부 내가 직접 버렸을 때 발동할 수 있다. 발동하면 그 13장이 손패로 돌아와 13면 대기가 되고 다음 순에 화료한다.\n\n각성하면 요구패를 버린 기록이 사라져 후리텐이 풀린다. 치·퐁·깡을 한 번이라도 하면 그 국에는 각성할 수 없다. 리치 중에도 사용할 수 없다.",
  install(ctx) {
