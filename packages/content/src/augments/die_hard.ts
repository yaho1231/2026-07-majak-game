...
export const dieHard: AugmentDef = defineAugment({
  ...
  name: "죽기살기",
  description:
    "(게임 내 1회) 내 점수가 12,500점 이하일 때 국에서 잃을 점수를 같은 크기의 플러스로 받는다. 예를 들어 8,000점을 방총하면 상대도 나도 8,000점을 받는다.",
  detail:
    "게임 내 1회, 국 정산 때 내 점수가 12,500점 이하이면 그 국에서 잃을 점수를 같은 크기의 플러스로 받는다. 예를 들어 8,000점을 방총하면 상대도 나도 8,000점을 받는다.\n\n상대는 원래대로 받고 차액은 뱅크가 낸다. 플러스로 바뀌는 점수는 최대 25,000점이다. 점수를 얻는 국에는 발동하지 않고 횟수도 줄지 않는다.",
  /*
