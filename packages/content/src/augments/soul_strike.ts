...
export const soulStrike: AugmentDef = defineAugment({
  ...
  detail:
    "(2국에 1회) 역만에는 추가 판이 붙지 않는다. 연속 쯔모는 패산을 실제로 소모하며, 그동안 버리는 패는 평소대로 론 대상이다.\n\n**폭주는 셋 중 먼저 오는 것으로 끝난다** — 방총, 상대의 후로(후로한 사람부터 진행), 여섯 번째 이후의 쯔모패를 버리기(하가부터 진행). 안깡은 다섯 번째 쯔모까지만 횟수를 소모한다.",
  install(ctx) {
