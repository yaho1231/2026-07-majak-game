...
export const soulStrike: AugmentDef = defineAugment({
  ...
  name: "영혼의 일격",
  description:
    "(2국에 1회 · 리치는 국당 한 번) 텐파이에서 발동하면 그 패로 리치를 걸고 연속으로 6번 쯔모한다. 그 리치는 2판(더블리치는 3판)으로 계산되고, 연속 쯔모 중의 쯔모 화료는 언제나 일발이다.",
  detail:
    "텐파이에서 발동하면 그 패로 리치를 걸고 연속으로 6번 쯔모한다. 그 리치는 2판(더블리치는 3판, 역만 제외)이고, 연속 쯔모 중의 쯔모 화료는 언제나 일발이다.\n\n연속 쯔모는 방총당하거나, 상대가 후로하거나, 여섯 번째 이후의 쯔모패를 버리면 끝난다. 그동안 버리는 패는 평소대로 론 대상이다.\n\n리치는 국당 한 번이므로 리치 증강을 여러 개 가지고 있어도 그 국에는 하나만 사용할 수 있다.",
  install(ctx) {
