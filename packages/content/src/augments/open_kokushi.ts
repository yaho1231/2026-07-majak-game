...
export const openKokushi: AugmentDef = defineAugment({
  ...
  detail:
    "(상시) 상대가 버린 요구패 1장과 손패의 요구패 2장을 합쳐 하나의 묶음으로 퐁한다. 횟수 제한이 없고 완성 시 정식 역만 13판이며, 머리(작두)는 반드시 울지 않은 손패로 만들어야 한다.\n\n한 번 부르면 **평범한 치·퐁·깡(안깡 포함)이 전부 막힌다.** 반대로 평범한 치·퐁·깡을 이미 한 뒤에는 이 퐁을 부를 수 없다.",
  /**
