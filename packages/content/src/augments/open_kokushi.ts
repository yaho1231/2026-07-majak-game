 ...
 * 머리(또이쯔)는 반드시 울지 않은 손패로 만들어야 한다. 퐁 횟수 제한은 없다.
 ...
 * 실패하고 `kokushiOnly`가 표준형·치또이까지 막아 **그 국이 통째로 잠겼다**
...
export const openKokushi: AugmentDef = defineAugment({
  ...
  name: "우는 국사무쌍",
  description:
    "(상시) 요구패 3장을 퐁해 국사무쌍을 만들 수 있다. 한 번 국사퐁을 쓰면 그 국은 국사무쌍으로만 화료할 수 있다.",
  detail:
    "상대가 버린 요구패 1장과 손패의 요구패 2장을 합쳐 하나의 묶음으로 퐁한다. 횟수 제한이 없고 완성 시 정식 역만 13판이며, 머리(또이쯔)는 반드시 울지 않은 손패로 만들어야 한다.\n\n한 번 부르면 그 국은 **국사무쌍으로만 화료할 수 있고**, 평범한 치·퐁·깡(안깡 포함)도 전부 막힌다. 반대로 평범한 치·퐁·깡을 이미 한 뒤에는 이 퐁을 부를 수 없다.",
  /**
