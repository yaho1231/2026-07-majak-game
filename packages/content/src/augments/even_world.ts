...
export const evenWorld: AugmentDef = defineAugment({
  ...
  detail:
    "(2국에 1회) 무늬는 그대로 두고 홀수만 오르며, 9는 위가 없어 8로 내려온다. 자패와 이미 짝수인 패, 지금 도라인 홀수 패와 적도라(빨간 5)는 건드리지 않는다.\n\n바꾼 **결과**가 도라가 되는 것은 막지 않는다. 리치 중에는 발동할 수 없고, 한 번 쓰면 국이 두 번 지나야 다시 열린다(본장도 한 국으로 센다).",
  install(ctx) {
