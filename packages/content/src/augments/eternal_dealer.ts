...
export const eternalDealer: AugmentDef = defineAugment({
  ...
  name: "만년 오야",
  description:
    "(상시 · 연장은 동풍전 3회 · 반장전 5회) 내 화료는 언제나 오야 점수(약 1.5배)로 계산되고, 역패 '동'이 하나 더 추가된다. 내가 화료하면 다음 국의 오야가 내 자리로 온다.",
  detail:
    "내 화료는 항상 오야 점수(1.5배)로 계산되고 역패 '동'이 하나 더 추가된다. 원래 자풍은 그대로 두고 동 커쯔에 1판이 더해진다. 장풍이 동인 국이면 더블동이 된다.\n\n내가 화료하면 다음 국 오야가 내 자리로 온다. 연장은 동풍전 3회 · 반장전 5회까지다. 내가 진짜 오야일 때의 화료는 횟수를 소모하지 않는다.",
  install(ctx) {
