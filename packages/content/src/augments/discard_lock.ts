...
export const discardLock: AugmentDef = defineAugment({
  ...
  detail:
    "자기 순의 국 시작에 발동하면 상대 각자의 손패에서 무작위 수패 2종류가 한 장씩 이번 국 동안 버릴 수 없게 잠긴다.\n\n같은 종류를 여러 장 가지고 있어도 잠기는 것은 한 장뿐이고, 나중에 새로 쯔모한 같은 종류의 패는 자유롭게 버릴 수 있다. 잠긴 실제 패는 나에게만 보인다.",
  install(ctx) {
