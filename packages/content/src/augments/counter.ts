...
export const counter: AugmentDef = defineAugment({
  ...
  name: "카운터",
  description:
    "(매 국 1회) 나보다 먼저 리치를 건 상대에게 추격 리치로 반격한다 — 내가 **먼저 화료하면 그 상대가 받았을 점수까지 통째로 내가 받고**, 그 상대를 **직격 론**으로 잡으면 **+3판**을 얹는다.",
  detail:
    "(매 국 1회) 핵심은 **선리치자의 손 가치를 가로채는 것**이다.\n\n① 내가 그 국을 먼저 화료하면(그 상대가 함께 오르지 않았다면), 그 상대의 손이 올랐을 때 받았을 최고 점수를 뱅크에서 **통째로 더** 받는다 — 상대가 비싼 손으로 리치를 걸수록 내 몫이 커진다.\n② 그 상대의 버림패를 **직격 론**으로 잡으면 여기에 **+3판**이 더 붙는다(①과 중복).\n\n반격을 거는 순간의 부수 효과로 내 공탁 1,000점을 그 상대가 대납하고 그 상대의 일발이 사라진다. 대상은 그 국에 **스스로** 가장 먼저 리치를 건 한 사람뿐이고(남이 강제한 리치는 대상이 아니다), 대납액은 그 상대의 남은 점수까지만이다. 내가 공탁을 내지 않는 리치로 추격하면 그 1,000점은 내 점수로 들어온다.",
  install(ctx) {
