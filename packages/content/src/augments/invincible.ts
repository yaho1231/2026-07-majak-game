...
export const invincible: AugmentDef = defineAugment({
  ...
  name: "천하무적",
  description:
    "(2국에 1회) 자기 순에 선언하면 이번 국이 끝날 때까지 상대는 내 버림패로 론할 수 없다. 무엇을 버려도 방총이 나지 않지만 내 가깡을 창깡당하는 것은 막지 못한다.",
  detail:
    "(2국에 1회) 자기 순에 선언하면 그 국이 끝날 때까지 상대가 내 버림패로 론할 수 없다. 선언한 사실은 국이 끝날 때까지 전원에게 표시되므로, 상대는 론 버튼이 왜 안 뜨는지 알고 쯔모·유국 쪽으로 방향을 튼다. 다만 상대의 쯔모 화료, 내가 가깡한 패를 창깡으로 잡히는 것, 유국 노텐 벌점은 막지 못한다.",
