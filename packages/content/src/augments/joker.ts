 ...
 * (2026-09-14 사용자 지시, #511). 매치 길이에 비례해 늘리는 `scaledCooldown` 규약을
 * 따른다(brief_fog·broken_border·async_chiitoi 와 같은 계보).
 *
 * ⚠ #511 은 5분 뒤 머지된 #512 에 통째로 되돌려졌다(오래된 base 의 squash 머지 —
 *   docs/55 §2-1 M-1). 2026-09-16 에 손으로 다시 적용했다. 고정 상수로 되돌리면
 *   `joker.test.ts` «동풍전 2국에 1회 · 반장전 3국에 1회» 묶음이 실패한다.
 */
