...
export const futureSight: AugmentDef = defineAugment({
  ...
  name: "미래를 보는 자",
  description:
    "손패 무작위 3장을 뽑아 패산 위 3장과 교환한다. 이때 선택한 패를 내 바닥에 버린다. 화료시 교환횟수마다 +1판.",
  detail:
    "손패에서 무작위 3장이 뽑혀 패산 위 3장과 바뀐다. 뽑힌 3장 중 하나는 내가 골라 내 바닥에 버리고, 나머지는 패산 밑으로 간다. 이번 국의 교환 횟수만큼 화료에 +1판(역만 제외).\n\n⚠ 뽑힌 3장은 상대에게도 공개된다. 버튼을 누른 순간 쿨다운이 돌고, 판은 실제로 교환했을 때만 쌓인다. 버린 패는 후리텐을 만들지만 론·후로 대상은 아니다. 리치 중에는 쓸 수 없다.",
  install(ctx) {
