...
export const asyncChiitoi: AugmentDef = defineAugment({
  ...
  name: "비대칭",
  description:
    "(2국에 1회) 자기 순에 발동하면 이번 국 동안 치또이쯔의 무늬 제한이 사라진다 — 1만·1통도 한 또이쯔다.",
  detail:
    "(2국에 1회) 발동한 국에만 열리고, 한 번 쓰면 2국이 지나야 다시 열린다. 그 국 동안은 숫자만 같으면 무늬가 달라도 한 쌍이다. 자패는 기존처럼 같은 종류 2장이어야 하고, 같은 패는 최대 2장까지만 쓸 수 있다(4장을 2쌍으로 쓰지 못한다).\n\n같은 패가 3장 모이면 그 손은 치또이가 아니라 일반 손으로 읽히고, 안커가 있으면 머리보다 안커로 우선 취급된다. 발동은 전원에게 공개되고, 리치 중에는 발동할 수 없다.",
