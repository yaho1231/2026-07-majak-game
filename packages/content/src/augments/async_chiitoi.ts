...
export const asyncChiitoi: AugmentDef = defineAugment({
  ...
  detail:
    "**국의 첫 순에만 발동할 수 있다** — 이 국에 한 장이라도 버린 뒤에는 잠긴다. 무늬 제한은 발동한 국 동안만 풀린다. 자패는 기존처럼 같은 종류 2장이어야 하고, 같은 패는 최대 2장까지만 쓸 수 있다(4장을 2쌍으로 쓰지 못한다).\n\n한 번 쓰면 동풍전은 2국, 반장전은 3국이 지나야 다시 열린다. 발동은 전원에게 공개되고, 리치 중에는 발동할 수 없다.",
