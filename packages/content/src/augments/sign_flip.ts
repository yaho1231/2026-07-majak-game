...
export const signFlip: AugmentDef = defineAugment({
  ...
  detail:
    "이번 국에 내 점수가 움직인 만큼, 부호만 뒤집어 정산한다.\n\n−8,000 → +8,000\n+1,000 → −1,000\n\n방총·쯔모 지불·리치 공탁·본장·유국 텐파이료가 모두 포함된다. 뒤집혀 돌아오는 몫은 한 국에 25,000점까지다.\n\n상대 점수는 그대로 움직이고, 차액은 뱅크가 낸다. 켜면 전원에게 공개된다.\n\n자기 첫 순(아직 한 장도 버리지 않았을 때)에만 켤 수 있고, 켠 국으로부터 3국이 지나면 다시 쓸 수 있다.",
  install(ctx) {
