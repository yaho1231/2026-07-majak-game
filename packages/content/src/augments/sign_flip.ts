...
export const signFlip: AugmentDef = defineAugment({
  ...
  name: "반전",
  description:
    "(3국에 1회 · 자기 첫 순 · 이번 국만) 이번 국에 내가 얻거나 잃을 점수의 부호를 뒤집는다. 예를 들어 8,000점을 잃을 상황이면 8,000점을 얻고, 1,000점을 얻을 상황이면 1,000점을 잃는다.",
  detail:
    "자기 첫 순에 사용하면 이번 국 내 점수 변동의 부호가 뒤집힌다. 예를 들어 8,000점을 잃으면 8,000점을 얻고, 1,000점을 얻으면 1,000점을 잃는다.\n\n방총·쯔모 지불·리치 공탁·본장·유국 텐파이료가 전부 포함되고, 뒤집혀서 얻는 점수는 25,000점까지다. 상대 점수는 원래대로 움직이고 차액은 뱅크가 낸다.",
  install(ctx) {
