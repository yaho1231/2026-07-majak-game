...
export const meldDissolve: AugmentDef = defineAugment({
  ...
  name: "파혼",
  description:
    "(매 국 1회) 자기 순에 자신의 후로(치·퐁) 하나를 해체한다 — 내가 냈던 2장만 손으로 돌아오고, 빈 자리는 패산에서 보충된다.",
  detail:
    "(매 국 1회) 남에게서 가져왔던 한 장은 그 사람의 버림패 더미로 되돌아간다. 후로가 하나뿐이었다면 그 순간 손이 다시 멘젠이 되어 리치를 걸 수 있다.\n\n해체는 전원에게 공개된다. 깡은 대상이 아니고, 패산이 비면 발동할 수 없다.",
  install(ctx) {
