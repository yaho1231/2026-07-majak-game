...
export const foresight: AugmentDef = defineAugment({
  ...
  name: "예지",
  description:
    "(열람 4순에 1회 · 재배열은 국에 1회) 자기 순에 발동하면 패산 다음 4장이 나에게만 공개된다. 발동은 취소할 수 없다. 국에 한 번은 드래그로 그 순서를 바꿀 수 있다. 발동한 국에 화료하면 +2판을 받는다. 역만에는 적용되지 않고, 동풍전 2회 · 반장전 3회까지다.",
  detail:
    "발동하면 패산 다음 4장이 나에게만 보이고, 국에 한 번은 드래그로 그 순서를 바꿀 수 있다. 발동한 국에 화료하면 +2판을 받는다. 역만에는 적용되지 않고, 동풍전 2회 · 반장전 3회까지다.\n\n4장은 지금 차례 기준 하가·대면·상가·나 순서로 배정되지만, 중간에 누가 울면 순서가 밀려 네 번째가 내 쯔모가 아닐 수 있다.",
  install(ctx) {
