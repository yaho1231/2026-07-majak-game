...
export const riichiSeal: AugmentDef = defineAugment({
  ...
  detail:
    "그 국의 첫 리치를 내가 선언하면 나머지 셋의 리치가 잠기고, 잠긴 상대는 리치·일발·뒷도라를 통째로 잃는다. 나보다 먼저 리치를 건 사람이 있으면 봉인은 아예 서지 않는다.\n\n봉인은 내가 그 리치를 지고 있는 동안만 살아 있다 — 리치를 풀면 함께 풀리고, 그 사이 남이 리치를 걸면 다시 걸어도 돌아오지 않는다. 봉인 사실은 전원에게 공개된다.",
