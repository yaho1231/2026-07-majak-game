...
export const riichiSeal: AugmentDef = defineAugment({
  ...
  name: "리치 봉인",
  description:
    "(매 국 1회 — 그 국의 첫 리치를 내가 선언할 때) 내가 그 리치를 지고 있는 동안 다른 셋은 리치를 걸 수 없다. 승부수로 리치를 풀면 봉인도 풀린다. 추가 점수는 붙지 않는다.",
  detail:
    "(매 국 1회 — 그 국의 첫 리치를 내가 선언할 때) 국의 첫 리치를 내가 선언하는 순간 나머지 세 명의 리치가 잠겨, 상대는 리치·일발·뒷도라라는 최대 화력 수단을 통째로 잃는다. 봉인은 내가 그 리치를 지고 있는 동안만 유지된다 — 승부수로 리치를 풀면 봉인도 그 자리에서 풀리고, 그 사이 상대가 리치를 걸었다면 같은 국에 다시 걸어도 봉인은 돌아오지 않는다. 국이 바뀌면 초기화되어, 다음 국에 다시 선제 리치를 걸면 그 국 동안 또 봉인된다. 나보다 먼저 리치를 건 사람이 있으면 봉인은 아예 서지 않으며, 이미 선언된 리치를 되돌리지도 않는다. 봉인 사실은 전원에게 공개된다. 점수는 1점도 늘지 않는다.",
