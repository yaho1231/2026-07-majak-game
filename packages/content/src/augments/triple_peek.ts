...
export const triplePeek: AugmentDef = defineAugment({
  ...
  detail:
    "(2국에 1회) 보이는 것은 실제 패가 아니라 앞으로 내게 배정될 쯔모의 '종류'다. 누가 퐁·치·깡을 해 차례가 밀려도 지금 기준으로 다시 계산돼 어긋나지 않는다. 상대에게는 발동 사실만 공개된다.\n\n선언 시점에 내 몫의 쯔모가 3장 남지 않았으면 발동할 수 없다. 한 번 쓰면 다음 국은 건너뛴다.",
