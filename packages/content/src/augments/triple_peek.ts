 ...
 *
 * 동풍전 1·반장전 2회, 자기 턴(turn.act)에 선언하면 **내 다음 쯔모 세 장의 종류**가
 ...
 *
 * 설계 결정:
 * - 액션 `triple_peek_use {}` 하나. turn.act·자기 턴·동풍전 1·반장전 2회·패산이 충분할 때만.
 ...
 * - 플래그는 **게임 단위**라 roundKey를 섞지 않는다(`triple_peek:used:<holder>`).
 */
