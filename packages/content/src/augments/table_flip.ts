...
export const tableFlip: AugmentDef = defineAugment({
  ...
  name: "밥상 뒤엎기",
  description:
    "(매 국 1회) 배패 직후 첫 순에 손패를 전부 산에 반납하고 패산에서 새 손을 받는다. 반납한 손패는 전원에게 공개된다.",
  detail:
    "(매 국 1회) 국의 첫 순에 마음에 안 드는 배패를 통째로 엎을 수 있다. 손패는 패산 맨 밑으로 반납되고 패산 위에서 같은 장수를 새로 받으며 패산 총량은 변하지 않는다. 반납한 손패 13장은 전원에게 공개된다.",
  install(ctx) {
