...
export const doraAfterimage: AugmentDef = defineAugment({
  ...
  name: "잔상",
  description:
    "(2국에 1회) 자기 순에 발동하면 직전 국의 도라가 되살아나, 이번 국의 도라 위에 나만의 도라로 겹쳐진다.",
  detail:
    "(2국에 1회) 대상은 직전 국의 배패 표시패와 깡도라 표시패이며, 뒷도라 표시패는 포함되지 않는다. 발동 시점에 종류가 고정되어 이후 깡도라가 뒤집혀도 변하지 않는다.\n\n첫 국에는 발동할 수 없다. 되살릴 수 있는 도라는 발동 전부터 보유자에게만 보이고, 되살아난 종류는 전원에게 공개된다.",
  install(ctx) {
