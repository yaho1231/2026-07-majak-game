...
export const openRiichiReveal: AugmentDef = defineAugment({
  ...
  name: "오픈 리치",
  description:
    "오름패를 공개하고 리치. 리치를 걸지않은 사람이 방총당하면 그 화료는 역만이 된다.",
  detail:
    "오름패를 공개하고 리치한다. 리치를 걸지 않은 사람이 쏘면 그 화료는 역만이 된다.\n\n그 외의 화료(쯔모·리치자에게서 론)에서는 리치가 3판(+2판, 역만 제외)이다. 손패 전체가 아니라 오름패만 공개된다.\n\n리치는 국당 한 번이므로 리치 증강을 여럿 들어도 그 국에는 하나만 쓸 수 있다.",
