...
export const openRiichiReveal: AugmentDef = defineAugment({
  ...
  name: "오픈 리치",
  description:
    "(매 국 1회 · 리치는 국당 한 번) 멘젠·텐파이 상태에서 공탁 1,000점을 걸고 오픈 리치를 선언한다. 오름패가 전원에게 공개되며, 리치를 걸지 않은 사람이 그 오름패로 방총하면 그 화료는 역만이 된다.",
  detail:
    "(매 국 1회 · 리치는 국당 한 번) 멘젠 텐파이 상태에서 공탁 1,000점을 걸고 오픈 리치를 선언한다. 표준 리치와 똑같이 손이 잠기고, 여기에 더해 자신의 오름패가 전원에게 공개된다. 리치를 걸지 않은 사람에게서 론으로 화료하면 그 화료는 역만이 되고, 그 외의 화료(쯔모 · 리치자에게서 론)에서는 그 리치를 3판으로 취급한다(역만에는 미적용). 손패 전체가 드러나지는 않고 오름패만 공개된다.",
