...
export const callSeal: AugmentDef = defineAugment({
  ...
  name: "함구령",
  description:
    "(동풍전 1회 · 반장전 2회) 자기 순에 선언하면 6순 동안 상대 셋의 후로(치·퐁·대명깡)가 전부 봉인된다. 안깡·가깡은 막지 않는다.",
  detail:
    "(동풍전 1회 · 반장전 2회) 자기 손 안에서 완결되는 안깡·가깡은 봉인되지 않는다. 6순이 지나면 봉인이 풀리고, 6순이 다 가기 전에 국이 끝나면 함께 걷힌다(사용 횟수는 돌아오지 않는다). 발동은 전원에게 공개된다.",
