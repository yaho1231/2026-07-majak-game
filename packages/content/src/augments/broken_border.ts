...
export const brokenBorder: AugmentDef = defineAugment({
  ...
  detail:
    "**국의 첫 순에만 발동할 수 있다** — 이 국에 한 장이라도 버린 뒤에는 잠긴다. 무늬 제한은 화료·텐파이·대기 판정과 치 전부에서 사라진다. 열려 있는 것은 발동한 그 국뿐이고, 한 번 쓰면 동풍전은 2국·반장전은 3국이 지나야 다시 열린다. 혼색으로 만든 슌쯔는 청일색·삼색동순·일기통관을 성립시키지 않는다.\n\n커쯔(2만·2통·2삭)에는 적용되지 않는다. 발동은 전원에게 공개되고, 리치 중에는 발동할 수 없다.",
