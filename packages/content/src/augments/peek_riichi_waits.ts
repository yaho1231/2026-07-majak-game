...
export const peekRiichiWaits: AugmentDef = defineAugment({
  ...
  name: "선언 간파",
  description:
    "(매 국 1회 + 위조 1회) 리치한 상대의 오름패를 확인하고, 한 번 더 쓰면 내 손패 한 장을 간파해 둔 오름패로 바꾼다.",
  detail:
    "리치 중인 상대 하나를 자기 순에 지목해 그 오름패를 들여다본다. 확인 결과는 나만 본다.\n\n위조는 간파한 그 국에, **내가 리치를 걸기 전에만** 된다. 손패 한 장을 간파해 둔 오름패로 바꿔 만드는 것이며, 이미 4장이 다 나온 종류로는 만들지 못한다.",
