...
export const peekRiichiWaits: AugmentDef = defineAugment({
  ...
  detail:
    "(매 국 1회 + 위조 1회) 자기 순에 리치 중인 상대를 지목해 그 오름패를 자신만 확인한다. 알아낸 대기는 그 국에만 유효하다. 간파한 국에는 추가로 1회, 내 손패 한 장을 간파한 오름패 중 하나로 바꿔 만들 수 있다. 위조는 **내가 리치를 걸기 전에만** 된다 — 리치를 걸면 손이 잠긴다.",
