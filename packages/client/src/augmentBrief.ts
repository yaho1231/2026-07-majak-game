...
export const AUGMENT_BRIEF: Record<string, AugmentBrief> = {
  ...
  palm_flip: { use: "2국에 1회", text: "리치 중 한 번, 쯔모기리 대신 원하는 패를 버려 대기를 갈아탄다." },
  ...
  push_riichi: { use: "매 국 1회", text: "상대 하나에게 낙인 — 리치 가능한 상태로 버리면 강제로 리치가 된다." },
  rank_gate: { use: "매 국 1회", text: "국 첫 순에 지목한 상대는 이번 국에 4판 이하로 화료하지 못한다." },
  ...
  table_flip: { use: "매 국 1회", text: "국 첫 순에 손패를 통째로 갈아 낀다. 버린 손패는 전원에게 공개된다." },
  ...
  unification: { use: "상시", text: "내 점수가 45,000점에 닿는 순간 남은 국을 무시하고 즉시 우승." },
