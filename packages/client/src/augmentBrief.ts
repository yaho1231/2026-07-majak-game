...
export const AUGMENT_BRIEF: Record<string, AugmentBrief> = {
  ...
  blood_contract: { use: "매 국 1회", text: "첫 타패 전에 역 하나를 걸고, 그 역으로 화료하면 점수가 1.5배." },
  ...
  giant_god: { use: "국당 1회", text: "내 바닥의 국사무쌍 13종을 손으로 끌어올려 13면 텐파이 — 다음 순에 화료한다." },
  ...
  seat_swap: { use: "국당 1회", text: "국 첫 순에 상대와 자리·손패를 맞바꾼다. 자풍·오야까지 따라온다." },
  ...
  table_flip: { use: "매 국 1회", text: "첫 순에 손패를 전부 반납하고 패산에서 새 손패를 받는다." },
  ...
  unification: { use: "상시", text: "내 점수가 45000점에 닿는 순간 남은 국을 무시하고 즉시 우승." },
