...
export const LESSONS: readonly Lesson[] = [
  ...
  },
  {
    ...
    todo: "리치 버튼을 누른 뒤, 오른쪽 끝에 떨어져 있는 방금 가져온 패를 누르세요.",
    anchor: ".act-riichi",
  ...
  },
  {
     ...
     * 게임 무효 요청.
     */
    body: "패를 버리는 방식(두 번 눌러 버리기, 우클릭 쯔모기리), 내 오름패 표시, 화면 효과와 소리, 연출 속도를 여기서 바꿀 수 있습니다. 맨 아래에는 게임 무효 요청도 있습니다. 자동정렬이나 자동화료는 여기가 아니라 방금 본 왼쪽 아래 버튼에 있습니다.",
    todo: "오른쪽 위 ⚙ 버튼을 눌러 열어 보세요.",
    anchor: ".settings-btn",
    when: (c) => !c.draftOpen && handsFree(c),
