...
export const LESSONS: readonly Lesson[] = [
  ...
  // ─────────── 기본 조작 ───────────
  {
     ...
     */
    body: "처음에 13장을 쥐고, 내 차례가 되면 한 장을 더 가져와 열네 장이 됩니다 — 오른쪽 끝에 떨어져 붙어 있는 것이 방금 가져온 패입니다. 지금은 «자동정렬»이 켜져 있어 만·통·삭·자패 순으로 저절로 정리됩니다. 손수 배열을 잡고 싶으면 왼쪽 아래 «자동정렬»을 끄세요 — 그때부터 끌어서 순서를 바꿀 수 있습니다.",
    anchor: ".own-hand",
  ...
  },
  {
    ...
    body: "한 장만 더 맞으면 완성이라는 뜻입니다. 리치는 1,000점을 걸고 점수를 크게 올립니다. 대신 손이 잠겨, 이후에는 가져온 패를 그대로 버리게 됩니다.",
  ...
  },
  {
    ...
    body: "손이 잠겨 가져온 패를 그대로 버리게 됩니다. 여기서부터 할 일은 하나뿐입니다: 상대 셋 중 누군가가 내 오름패를 버리면 빨간 «론» 버튼이 뜹니다. 그때 누르면 끝입니다.",
  ...
  },
  {
    ...
    body: "펼쳐진 설명 안의 «자세히 ▾»를 누르면 작동 원리와 주의점까지 나옵니다. Shift를 누르고 있는 동안에도 같은 것이 펼쳐집니다. 다 읽었으면 Esc를 누르거나 증강 이름을 다시 눌러 접으세요.",
...

  {
    ...
    urgent: true,
    title: "점수는 «판 × 부»로 정해집니다",
    body: "가운데 원의 «N판»은 역과 도라를 합한 크기고, 작은 글씨 «M부»는 손 모양에 붙는 잔점수입니다. 둘을 곱해 실제 점수가 나오고, 아래 표의 ±숫자가 이번에 실제로 오간 점수입니다. 역 이름과 «N판 M부»는 눌러 보면 풀이가 뜹니다.",
  ...
  },
  {
     ...
     */
    body: "리치를 걸고 화료까지 해 보셨습니다. 실제 대국에는 한 수마다 30초가 걸립니다 — 시간이 다 되면 자동으로 패스하거나 방금 가져온 패를 그대로 버립니다(증강 고르기는 첫 번째만 넉넉합니다). 나머지는 두면서 익히면 됩니다. «알겠어요»를 누르면 이 판을 접고 처음 화면으로 돌아갑니다 — «🎓 튜토리얼»은 로그인 화면과 홈 양쪽에 있으니 언제든 다시 오세요.",
