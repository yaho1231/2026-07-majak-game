...
export const LESSONS: readonly Lesson[] = [
  ...
  },
  {
     ...
     */
    body: "리치를 걸고 화료까지 해 보셨습니다. 실제 대국에는 한 수마다 30초가 걸립니다 — 시간이 다 되면 자동으로 패스하거나 방금 가져온 패가 그대로 나갑니다(증강 고르기는 첫 번째만 넉넉합니다). 나머지는 두면서 익히면 됩니다. «알겠어요»를 누르면 이 판을 접고 처음 화면으로 돌아갑니다 — «🎓 튜토리얼»은 로그인 화면과 홈 양쪽에 있으니 언제든 다시 오세요.",
