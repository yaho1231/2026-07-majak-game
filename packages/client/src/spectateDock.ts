...
export const DOCK_SECTIONS: readonly {
  ...
  { id: "seats", label: "좌석 분석", hint: "좌석별 점수, 샹텐, 지금 화료하면 받는 점수, 도라, 배패 점수, 증강" },
  {
    id: "waits",
    label: "오름패",
    hint: "좌석 분석 카드 안의 오름패 줄입니다. 남은 장수와 그 패로 화료했을 때의 론·쯔모 점수를 보여 줍니다. 끄면 판 위의 쏘이는 패 표시도 함께 꺼집니다.",
    standalone: false,
  },
  {
    id: "danger",
    label: "위험패",
    hint: "쏘이는 패와 지금 두는 좌석의 손패 위험도 추정입니다. 끄면 판 위의 위험도 색칠도 함께 꺼집니다.",
  },
  {
    id: "nextDraw",
    label: "다음 쯔모",
    hint: "패산 앞장과 그 패를 뽑을 사람을 보여 줍니다. 가장 강한 스포일러입니다.",
  },
