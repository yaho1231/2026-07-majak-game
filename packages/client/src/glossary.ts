...
export const GLOSSARY: readonly GlossaryEntry[] = [
  ...
  },
  {
    ...
    group: "win",
    label: "샹텐",
    short: "텐파이까지 몇 장을 더 바꿔야 하는지. 1장이면 이샹텐, 2장이면 량샹텐, 3장 산샹텐, 4장 스샹텐.",
    long:
      "텐파이가 되기까지 바꿔야 하는 패의 수. 한 장이면 이샹텐, 두 장이면 량샹텐, 이어서 산샹텐·스샹텐·우샹텐·로샹텐·치샹텐, 가장 먼 것이 파샹텐(여덟 장)이다. 숫자가 작을수록 완성에 가깝다.",
    match: ["[이량산스우로치파]?샹텐"],
  },
  {
    key: "noten",
