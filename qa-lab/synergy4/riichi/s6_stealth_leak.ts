...
run(["stealth_riichi", "soul_hunt"]);
run(["stealth_riichi", "ankan_dora"]);
run(["stealth_riichi", "pond_snatch"]);
run(["stealth_riichi", "async_chiitoi"]);
run(["stealth_riichi", "riichi_seal"]);
run(["stealth_riichi", "open_riichi_reveal"]);
run(["stealth_riichi", "all_or_nothing"]);
run(["stealth_riichi", "off_by_one"]);
run(["stealth_riichi", "palm_flip"]);
run(["stealth_riichi", "soul_strike"]);
run(["stealth_riichi", "riichi_upgrade"]);
