...
| 확정 3 | 🟠 | 도움말 «판은 언제 끝나는가»가 거짓 — 서든데스(서입·남입)도 도비도 없다고 말한다 |
...
## 확정 3. 🟠 규칙 도움말 «판은 언제 끝나는가»가 **거짓이다** — 서든데스(서입·남입)도 도비도 없다고 말한다
...
- 영향: 규칙을 배우러 온 사람이 «오라스»를 잘못 잡는다. 로비 툴팁이 스스로 적어 둔
  ...
  수가 마지막 국이 아니었거나, 반대로 도비로 갑자기 끝난다. 화면 안에서 로비
...
- 제안 수정: 문단 하나를 로비 툴팁과 같은 사실로 맞춘다 — 「정규 구간이 끝나도 1위가
  ...
  그 장에는 증강 획득이 없습니다). 누군가 0점 아래로 떨어지면 그 자리에서 끝납니다(도비).」
