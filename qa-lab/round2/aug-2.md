...
- 광역 스위프(`qa-lab/round2/aug-2/sweep.ts` — 28종 × 좌석1·2·중복보유, 페르소나 혼합)와
  ...
  잭팟 배수)는 115판 시점까지 **crash 0 / effectError 0 / violation 0**(보고 시점에도 계속 도는 중).
...
- 스위프는 augment당 6판(총 168판 예정) 규모로 돌렸고 끝까지 완주하지 못했다
  (완주분 115판까지 무결). 두 좌석 동시 보유 · 담당 증강 2개 조합은 스위프 안에 들어 있다.
